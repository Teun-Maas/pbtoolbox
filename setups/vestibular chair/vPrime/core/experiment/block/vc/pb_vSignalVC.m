...
% PBToolbox (2018): JJH: j.heckman@donders.ru.nl
   ...
   vSignal     = pb_vCreateSignal(1, signal(1).duration, 10, signal(1).frequency, signal(1).type,'axis','VER');
   hSignal     = pb_vCreateSignal(1, signal(2).duration, 10, signal(2).frequency, signal(2).type,'axis','HOR');
