function ORIENT_JJH_07(varargin)
% PB_VGENEXP_VIS
%
...
% PBToolbox (2022): JJH: j.heckman@donders.ru.nl
   ...
   GV.stim_fixlight        	= pb_keyval('fix_light',varargin,2);                     % If you want a fixation light (0=off, 1=cf, 2=wf)
   GV.stim_fixdur             = pb_keyval('fix_dur',varargin,1000);                    % fixation light duration in ms
   GV.stim_fixdelay           = pb_keyval('fixdelay',varargin,0);                      % pause after fixation light in ms.
