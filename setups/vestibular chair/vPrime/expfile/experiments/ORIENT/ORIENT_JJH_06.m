function ORIENT_JJH_06(varargin)
% PB_VGENEXP_VIS
%
...
% PBToolbox (2022): JJH: j.heckman@donders.ru.nl
   ...
   GV.vc_profile              = pb_keyval('vc_profile',varargin,[2 2]);                % Select the profile 1-6. [HOR/VERT]
   GV.vc_amplitude            = pb_keyval('vc_amplitude',varargin,[40 40]);              % Select the maximum amplitude. [HOR/VERT]
